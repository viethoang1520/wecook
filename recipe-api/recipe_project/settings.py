...
SECRET_KEY = "django-insecure-14$z0jy24q67^t_&eq4ej6!^59dni&wdjxay%nqc-qf1r3l&ja"
...
UPLOAD_DIRS = {
    ...
    'audios': os.path.join(MEDIA_ROOT, 'audios'),
    'transcriptions': os.path.join(MEDIA_ROOT, 'transcriptions'),
}
